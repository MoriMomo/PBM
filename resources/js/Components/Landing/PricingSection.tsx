...
const INCLUDED_ITEMS = [
  'Akses Live Webinar 90 Menit via Zoom',
  'Rekaman Full HD (Akses Selamanya Tanpa Batas)',
  'Ebook Panduan "Pembedahan Konversi Landing Page"',
  'Sesi Tanya Jawab & Konsultasi Kasus Bisnis Langsung',
  'Kesempatan Booking Sesi Landing Page Audit Personal GRATIS',
  'Akses Seluruh Modul & Template Checklist CRO Siap Pakai',
] as const;
          ...
          <div className="glass-card-featured rounded-3xl p-6 sm:p-10 relative overflow-hidden">
            ...
            <div className="text-center mb-6">
              <span className="inline-flex items-center gap-2 bg-brand-500/10 border border-brand-500/30 text-brand-300 px-4 py-2 rounded-full text-xs sm:text-sm font-mono font-bold">
                ...
                HARGA PROMO EARLY BIRD: DISKON 73%!
              </span>
            </div>
            ...
            <CTAButton
              ...
              id="pricing-cta"
              className="w-full"
              socialProof="🔒 Pembayaran Aman • Garansi 100% Uang Kembali Jika Tidak Puas"
            >
            ...
            <div className="mt-6 flex items-center justify-center gap-2 text-xs text-slate-400">
              ...
              <span>Garansi 100% uang kembali kalau materi tidak memberi wawasan baru buat bisnismu</span>
            </div>
          </div>
        </SectionReveal>
