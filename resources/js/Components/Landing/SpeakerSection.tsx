...
export default function SpeakerSection() {
  return (
    <section id="speaker" className="py-10 sm:py-14 px-4 sm:px-6 relative overflow-hidden">
          ...
          <div className="glass-card-featured rounded-3xl p-6 sm:p-10 relative overflow-hidden">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
              ...
              <div className="flex-shrink-0 relative">
                ...
                {/* Floating badge */}
                <div className="absolute -bottom-3 left-6 bg-gradient-to-r from-brand-600 to-accent-500 text-white font-mono text-[11px] font-bold px-4 py-1.5 rounded-full shadow-lg whitespace-nowrap">
                  CRO SPECIALIST
                </div>
              </div>
